...
**share_link** | **str** | Link to share the campaign on social medias | 
**tag** | **str** | Tag of the campaign | 
**created_at** | **str** | Creation date of the campaign (YYYY-MM-DD HH:mm:ss) | 
**modified_at** | **str** | Date of last modification of the campaign (YYYY-MM-DD HH:mm:ss) | 
