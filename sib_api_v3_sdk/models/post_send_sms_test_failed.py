...
class PostSendSmsTestFailed(object):
    ...
    def __init__(self, code=None, message=None, unexisting_sms=None, without_list_sms=None):
        """
    ...
    def code(self):
        """
        Gets the code of this PostSendSmsTestFailed.
        Response code

        :return: The code of this PostSendSmsTestFailed.
        :rtype: int
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this PostSendSmsTestFailed.
        :type: int
        """
        if code is None:
    ...
    def message(self):
        """
        Gets the message of this PostSendSmsTestFailed.
        Response message

        :return: The message of this PostSendSmsTestFailed.
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this PostSendSmsTestFailed.
        :type: str
        """
        if message is None:
    ...
    def unexisting_sms(self):
        """
        Gets the unexisting_sms of this PostSendSmsTestFailed.

        :return: The unexisting_sms of this PostSendSmsTestFailed.
        :rtype: list[str]
        """
    ...
    def unexisting_sms(self, unexisting_sms):
        ...
        :param unexisting_sms: The unexisting_sms of this PostSendSmsTestFailed.
        :type: list[str]
        """
    ...
    def without_list_sms(self):
        """
        Gets the without_list_sms of this PostSendSmsTestFailed.

        :return: The without_list_sms of this PostSendSmsTestFailed.
        :rtype: list[str]
        """
    ...
    def without_list_sms(self, without_list_sms):
        ...
        :param without_list_sms: The without_list_sms of this PostSendSmsTestFailed.
        :type: list[str]
        """
