...
class GetChildInfoStatistics(object):
    ...
    def __init__(self, previous_month_total_sent=None, current_month_total_sent=None, total_sent=None):
        """
    ...
    def previous_month_total_sent(self):
        """
        Gets the previous_month_total_sent of this GetChildInfoStatistics.
        Overall emails sent for the previous month

        :return: The previous_month_total_sent of this GetChildInfoStatistics.
        :rtype: int
        """
    ...
    def previous_month_total_sent(self, previous_month_total_sent):
        ...
        :param previous_month_total_sent: The previous_month_total_sent of this GetChildInfoStatistics.
        :type: int
        """
    ...
    def current_month_total_sent(self):
        """
        Gets the current_month_total_sent of this GetChildInfoStatistics.
        Overall emails sent for current month

        :return: The current_month_total_sent of this GetChildInfoStatistics.
        :rtype: int
        """
    ...
    def current_month_total_sent(self, current_month_total_sent):
        ...
        :param current_month_total_sent: The current_month_total_sent of this GetChildInfoStatistics.
        :type: int
        """
    ...
    def total_sent(self):
        """
        Gets the total_sent of this GetChildInfoStatistics.
        Overall emails sent for since the account exists

        :return: The total_sent of this GetChildInfoStatistics.
        :rtype: int
        """
    ...
    def total_sent(self, total_sent):
        ...
        :param total_sent: The total_sent of this GetChildInfoStatistics.
        :type: int
        """
