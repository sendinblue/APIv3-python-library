...
class UpdateContact(object):
    ...
    def attributes(self):
        ...
        Pass the set of attributes to be updated. These attributes must be present in your account. To update existing email address of a contact with the new one please pass EMAIL in attribtes. For example, `{ 'EMAIL':'newemail@domain.com', 'FNAME':'Ellie', 'LNAME':'Roger'}`  # noqa: E501
    ...
    def smtp_blacklist_sender(self):
        ...
        SMTP forbidden sender for contact. Use only for email Contact  # noqa: E501
