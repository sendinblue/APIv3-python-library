...
class CreateEmailCampaign(object):
    ...
    def sender(self):
        ...
        Sender details including email and name (optional). For example `{\"name\":\"xyz\", \"email\":\"example@abc.com\"}`  # noqa: E501
    ...
    def recipients(self):
        ...
        List ids to include/exclude from campaign  # noqa: E501
