...
class UpdateEmailCampaignRecipients(object):
    ...
    def exclusion_list_ids(self):
        """
        Gets the exclusion_list_ids of this UpdateEmailCampaignRecipients.
        List ids which have to be excluded from a campaign

        :return: The exclusion_list_ids of this UpdateEmailCampaignRecipients.
        :rtype: list[int]
        """
    ...
    def exclusion_list_ids(self, exclusion_list_ids):
        ...
        :param exclusion_list_ids: The exclusion_list_ids of this UpdateEmailCampaignRecipients.
        :type: list[int]
        """
    ...
    def list_ids(self):
        """
        Gets the list_ids of this UpdateEmailCampaignRecipients.
        Lists Ids to send the campaign to. REQUIRED if already not present in campaign and scheduledAt is not empty

        :return: The list_ids of this UpdateEmailCampaignRecipients.
        :rtype: list[int]
        """
    ...
    def list_ids(self, list_ids):
        ...
        :param list_ids: The list_ids of this UpdateEmailCampaignRecipients.
        :type: list[int]
        """
