...
class GetExtendedContactDetails(object):
    ...
    def __init__(self, email=None, id=None, email_blacklisted=None, sms_blacklisted=None, modified_at=None, list_ids=None, list_unsubscribed=None, attributes=None, statistics=None):
        """
    ...
    def email(self):
        """
        Gets the email of this GetExtendedContactDetails.
        Email address of the contact for which you requested the details

        :return: The email of this GetExtendedContactDetails.
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        ...
        :param email: The email of this GetExtendedContactDetails.
        :type: str
        """
        if email is None:
    ...
    def id(self):
        """
        Gets the id of this GetExtendedContactDetails.
        ID of the contact for which you requested the details

        :return: The id of this GetExtendedContactDetails.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this GetExtendedContactDetails.
        :type: int
        """
        if id is None:
    ...
    def email_blacklisted(self):
        """
        Gets the email_blacklisted of this GetExtendedContactDetails.
        Blacklist status for email campaigns (true=blacklisted, false=not blacklisted)

        :return: The email_blacklisted of this GetExtendedContactDetails.
        :rtype: bool
        """
    ...
    def email_blacklisted(self, email_blacklisted):
        ...
        :param email_blacklisted: The email_blacklisted of this GetExtendedContactDetails.
        :type: bool
        """
    ...
    def sms_blacklisted(self):
        """
        Gets the sms_blacklisted of this GetExtendedContactDetails.
        Blacklist status for SMS campaigns (true=blacklisted, false=not blacklisted)

        :return: The sms_blacklisted of this GetExtendedContactDetails.
        :rtype: bool
        """
    ...
    def sms_blacklisted(self, sms_blacklisted):
        ...
        :param sms_blacklisted: The sms_blacklisted of this GetExtendedContactDetails.
        :type: bool
        """
    ...
    def list_ids(self):
        """
        Gets the list_ids of this GetExtendedContactDetails.

        :return: The list_ids of this GetExtendedContactDetails.
        :rtype: list[int]
        """
    ...
    def list_ids(self, list_ids):
        ...
        :param list_ids: The list_ids of this GetExtendedContactDetails.
        :type: list[int]
        """
        if list_ids is None:
    ...
    def list_unsubscribed(self):
        """
        Gets the list_unsubscribed of this GetExtendedContactDetails.

        :return: The list_unsubscribed of this GetExtendedContactDetails.
        :rtype: list[int]
        """
    ...
    def list_unsubscribed(self, list_unsubscribed):
        ...
        :param list_unsubscribed: The list_unsubscribed of this GetExtendedContactDetails.
        :type: list[int]
        """
    ...
    def attributes(self):
        """
        Gets the attributes of this GetExtendedContactDetails.

        :return: The attributes of this GetExtendedContactDetails.
        :rtype: dict(str, str)
        """
    ...
    def attributes(self, attributes):
        ...
        :param attributes: The attributes of this GetExtendedContactDetails.
        :type: dict(str, str)
        """
    ...
    def statistics(self):
        """
        Gets the statistics of this GetExtendedContactDetails.

        :return: The statistics of this GetExtendedContactDetails.
    ...
    def statistics(self, statistics):
        ...
        :param statistics: The statistics of this GetExtendedContactDetails.
