...
class GetIpsFromSender(object):
    ...
    def ips(self):
        """
        Gets the ips of this GetIpsFromSender.
        Dedicated IP(s) linked to a sender

        :return: The ips of this GetIpsFromSender.
    ...
    def ips(self, ips):
        ...
        :param ips: The ips of this GetIpsFromSender.
        :type: list[GetIpFromSender]
        """
        if ips is None:
            raise ValueError("Invalid value for `ips`, must not be `None`")
