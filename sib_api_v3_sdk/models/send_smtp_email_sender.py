...
class SendSmtpEmailSender(object):
    ...
    def name(self):
        """
        Gets the name of this SendSmtpEmailSender.
        Sender Name from which the emails are sent

        :return: The name of this SendSmtpEmailSender.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this SendSmtpEmailSender.
        :type: str
        """
    ...
    def email(self):
        """
        Gets the email of this SendSmtpEmailSender.
        Sender Email from which the emails are sent

        :return: The email of this SendSmtpEmailSender.
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        ...
        :param email: The email of this SendSmtpEmailSender.
        :type: str
        """
        if email is None:
