...
class GetExtendedContactDetailsStatisticsUnsubscriptions(object):
    ...
    def __init__(self, user_unsubscription=None, admin_unsubscription=None):
        """
    ...
    def user_unsubscription(self):
        """
        Gets the user_unsubscription of this GetExtendedContactDetailsStatisticsUnsubscriptions.
        Contact unsubscribe via unsubscription link in a campaign

        :return: The user_unsubscription of this GetExtendedContactDetailsStatisticsUnsubscriptions.
    ...
    def user_unsubscription(self, user_unsubscription):
        ...
        :param user_unsubscription: The user_unsubscription of this GetExtendedContactDetailsStatisticsUnsubscriptions.
        :type: list[GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription]
        """
        if user_unsubscription is None:
            raise ValueError("Invalid value for `user_unsubscription`, must not be `None`")
    ...
    def admin_unsubscription(self):
        """
        Gets the admin_unsubscription of this GetExtendedContactDetailsStatisticsUnsubscriptions.
        Contact has been unsubscribed from the administrator

        :return: The admin_unsubscription of this GetExtendedContactDetailsStatisticsUnsubscriptions.
    ...
    def admin_unsubscription(self, admin_unsubscription):
        ...
        :param admin_unsubscription: The admin_unsubscription of this GetExtendedContactDetailsStatisticsUnsubscriptions.
        :type: list[GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription]
        """
        if admin_unsubscription is None:
            raise ValueError("Invalid value for `admin_unsubscription`, must not be `None`")
