...
class GetFolder(object):
    ...
    def __init__(self, id=None, name=None, total_blacklisted=None, total_subscribers=None, unique_subscribers=None):
        """
    ...
    def id(self):
        """
        Gets the id of this GetFolder.
        ID of the folder

        :return: The id of this GetFolder.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this GetFolder.
        :type: int
        """
        if id is None:
    ...
    def name(self):
        """
        Gets the name of this GetFolder.
        Name of the folder

        :return: The name of this GetFolder.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this GetFolder.
        :type: str
        """
        if name is None:
    ...
    def total_blacklisted(self):
        """
        Gets the total_blacklisted of this GetFolder.
        Number of blacklisted contacts in the folder

        :return: The total_blacklisted of this GetFolder.
        :rtype: int
        """
    ...
    def total_blacklisted(self, total_blacklisted):
        ...
        :param total_blacklisted: The total_blacklisted of this GetFolder.
        :type: int
        """
    ...
    def total_subscribers(self):
        """
        Gets the total_subscribers of this GetFolder.
        Number of contacts in the folder

        :return: The total_subscribers of this GetFolder.
        :rtype: int
        """
    ...
    def total_subscribers(self, total_subscribers):
        ...
        :param total_subscribers: The total_subscribers of this GetFolder.
        :type: int
        """
    ...
    def unique_subscribers(self):
        """
        Gets the unique_subscribers of this GetFolder.
        Number of unique contacts in the folder

        :return: The unique_subscribers of this GetFolder.
        :rtype: int
        """
    ...
    def unique_subscribers(self, unique_subscribers):
        ...
        :param unique_subscribers: The unique_subscribers of this GetFolder.
        :type: int
        """
        if unique_subscribers is None:
            raise ValueError("Invalid value for `unique_subscribers`, must not be `None`")
