...
class CreateSenderIps(object):
    ...
    def __init__(self, ip=None, domain=None, weight=None):
        """
    ...
    def ip(self):
        """
        Gets the ip of this CreateSenderIps.
        Dedicated IP available in your account

        :return: The ip of this CreateSenderIps.
        :rtype: str
        """
        return self._ip
    ...
    def ip(self, ip):
        ...
        :param ip: The ip of this CreateSenderIps.
        :type: str
        """
        if ip is None:
    ...
    def domain(self):
        """
        Gets the domain of this CreateSenderIps.
        Domain of the IP

        :return: The domain of this CreateSenderIps.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        ...
        :param domain: The domain of this CreateSenderIps.
        :type: str
        """
        if domain is None:
    ...
    def weight(self):
        """
        Gets the weight of this CreateSenderIps.
        ...
        :return: The weight of this CreateSenderIps.
        :rtype: int
        """
        return self._weight
    ...
    def weight(self, weight):
        ...
        :param weight: The weight of this CreateSenderIps.
        :type: int
        """
        if weight is not None and weight > 100:
            raise ValueError("Invalid value for `weight`, must be a value less than or equal to `100`")
