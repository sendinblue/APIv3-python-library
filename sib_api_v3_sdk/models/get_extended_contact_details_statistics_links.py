...
class GetExtendedContactDetailsStatisticsLinks(object):
    ...
    def __init__(self, count=None, event_time=None, ip=None, url=None):
        """
    ...
    def count(self):
        """
        Gets the count of this GetExtendedContactDetailsStatisticsLinks.
        Number of clicks on this link for the campaign

        :return: The count of this GetExtendedContactDetailsStatisticsLinks.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this GetExtendedContactDetailsStatisticsLinks.
        :type: int
        """
        if count is None:
    ...
    def ip(self):
        """
        Gets the ip of this GetExtendedContactDetailsStatisticsLinks.
        IP from which the user has clicked on the link

        :return: The ip of this GetExtendedContactDetailsStatisticsLinks.
        :rtype: str
        """
        return self._ip
    ...
    def ip(self, ip):
        ...
        :param ip: The ip of this GetExtendedContactDetailsStatisticsLinks.
        :type: str
        """
        if ip is None:
    ...
    def url(self):
        """
        Gets the url of this GetExtendedContactDetailsStatisticsLinks.
        URL of the clicked link

        :return: The url of this GetExtendedContactDetailsStatisticsLinks.
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        ...
        :param url: The url of this GetExtendedContactDetailsStatisticsLinks.
        :type: str
        """
        if url is None:
