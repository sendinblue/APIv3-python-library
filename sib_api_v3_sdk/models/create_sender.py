...
class CreateSender(object):
    ...
    def name(self):
        """
        Gets the name of this CreateSender.
        From Name to use for the sender

        :return: The name of this CreateSender.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this CreateSender.
        :type: str
        """
        if name is None:
    ...
    def email(self):
        """
        Gets the email of this CreateSender.
        From Email to use for the sender

        :return: The email of this CreateSender.
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        ...
        :param email: The email of this CreateSender.
        :type: str
        """
        if email is None:
    ...
    def ips(self):
        """
        Gets the ips of this CreateSender.
        Mandatory in case of dedicated IP, IPs to associate to the sender

        :return: The ips of this CreateSender.
    ...
    def ips(self, ips):
        ...
        :param ips: The ips of this CreateSender.
