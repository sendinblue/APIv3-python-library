...
class ProcessApi(object):
    ...
    def get_process(self, process_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_process(process_id, asynchro=True)
        >>> result = thread.get()
    ...
    def get_process_with_http_info(self, process_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass asynchro=True
        >>> thread = api.get_process_with_http_info(process_id, asynchro=True)
        >>> result = thread.get()
    ...
    def get_processes(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass asynchro=True
        >>> thread = api.get_processes(asynchro=True)
        >>> result = thread.get()
    ...
    def get_processes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass asynchro=True
        >>> thread = api.get_processes_with_http_info(asynchro=True)
        >>> result = thread.get()
