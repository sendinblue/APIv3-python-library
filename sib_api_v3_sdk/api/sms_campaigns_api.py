...
class SMSCampaignsApi(object):
    ...
    def send_test_sms(self, body, campaign_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param SendTestSms body: Mobile number of the recipient with the country code. This number must belong to one of your contacts in SendinBlue account and must not be blacklisted (required)
        :param int campaign_id: Id of the SMS campaign (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
